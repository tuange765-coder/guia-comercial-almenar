...
st.markdown("""
    <style>
    /* OCULTAR GITHUB Y MENÚS DE STREAMLIT SIN BLOQUEAR EL PANEL */
    #MainMenu {visibility: hidden;}
    footer {visibility: hidden;}
    .stDeployButton {display:none;}
    [data-testid="stStatusWidget"] {visibility: hidden;}
    
    /* Mantenemos el header técnico activo pero invisible visualmente */
...
if opcion_menu == "🔐 Administración":
    ...
    # Campo de clave visible directamente
