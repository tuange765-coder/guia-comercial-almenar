...
# --- PANEL ADMIN (ESTA SECCIÓN DEBE ESTAR AQUÍ) ---
...
# Lógica del Panel - IMPORTANTE: Sin esta indentación no funciona
if admin_pass == "Juan*316*":
    ...
    if menu == "Añadir":
        ...
        if not df_del.empty:
            target = st.sidebar.selectbox("Eliminar:", df_del['nombre'].tolist())
...
<div class='footer-willian'>
    ...
    Santa Teresa del Tuy, Venezuela 2026.
</div>
""", unsafe_allow_html=True)
